...
if (isset($_SESSION['quickad'][$access_token]['payment_type'])) {
    ...
    $user_phone = filter_var($userdata['phone'], FILTER_SANITIZE_STRING);
...
<div style="display: none">
    <form action="#" id="payment_form">
        ...
        <input type="text" id="txnid" name="txnid" placeholder="Transaction ID" value="<?php echo  htmlspecialchars($txnid,ENT_QUOTES ) ?>" />
        <input type="text" id="key" name="key" placeholder="Merchant Key" value="<?php echo htmlspecialchars($payumoney_merchant_key,ENT_QUOTES ) ?>" />
        <input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="<?php echo htmlspecialchars($payumoney_merchant_salt,ENT_QUOTES ) ?>" />
        <input type="text" id="amount" name="amount" placeholder="Amount" value="<?php echo htmlspecialchars($amount,ENT_QUOTES ) ?>" />
        <input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="<?php echo htmlspecialchars($title,ENT_QUOTES ) ?>" />
        <input type="text" id="fname" name="fname" placeholder="First Name" value="<?php echo htmlspecialchars($username,ENT_QUOTES ) ?>" />
        <input type="text" id="email" name="email" placeholder="Email ID" value="<?php echo htmlspecialchars($user_email,ENT_QUOTES ) ?>" />
        <input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="<?php echo htmlspecialchars($user_phone,ENT_QUOTES ) ?>" />
        <input type="text" id="hash" name="hash" placeholder="Hash" value="<?php echo htmlspecialchars($hash,ENT_QUOTES ) ?>" />
