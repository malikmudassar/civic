    ...
    switch ($action) {
        ...
        case 'stripe_payment_process':
            ...
            try {
                ...
                $cdata = array();
                $cdata['number'] = filter_var($_POST['stripeCardNumber'], FILTER_SANITIZE_STRING);
                $cdata['cvc'] = filter_var($_POST['stripeCardCVC'], FILTER_SANITIZE_STRING);
                $cdata['exp_month'] = filter_var($_POST['exp_month'], FILTER_SANITIZE_STRING);
                $cdata['exp_year'] = filter_var($_POST['exp_year'], FILTER_SANITIZE_STRING);
